...
(function(exports) {
      ...
      return function (v) {
          return function (ctx) {
              var viewCol = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Game line 205, column 5 - line 206, column 16: " + [ v1.constructor.name ]);
              };
  ...
  var transpose = function (v) {
      ...
      return Board.create((function () {
          ...
          throw new Error("Failed pattern match at Game line 279, column 11 - line 281, column 74: " + [ v1.constructor.name ]);
      })());
  };
  var stackRow = function (eqVal) {
      return function (v) {
          var stackLast = function (v1) {
              ...
              throw new Error("Failed pattern match at Game line 322, column 5 - line 322, column 43: " + [ v1.constructor.name ]);
          };
          ...
          var cellVal = function (v1) {
              ...
              throw new Error("Failed pattern match at Game line 325, column 5 - line 325, column 28: " + [ v1.constructor.name ]);
          };
          var stackCells = function (left) {
              return function (v1) {
                  ...
                  throw new Error("Failed pattern match at Game line 315, column 7 - line 321, column 54: " + [ v2.constructor.name ]);
              };
          };
  ...
  var stackBottom = function (eqVal) {
      return function ($278) {
          return transpose(stackRight(eqVal)(transpose($278)));
      };
  };
  ...
  var stackLeft = function (eqVal) {
      return function ($279) {
          return reverse(stackRight(eqVal)(reverse($279)));
      };
  };
  var stackTop = function (eqVal) {
      return function ($280) {
          return (function ($281) {
              return transpose(reverse(stackRight(eqVal)($281)));
          })(reverse(transpose($280)));
      };
  };
  var stackMove = function (eqVal) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Game line 246, column 1 - line 246, column 79: " + [ eqVal.constructor.name, v.constructor.name ]);
      };
  };
          ...
          var moveCol = function (v1) {
              return function (v2) {
                  return function (v3) {
                      ...
                      throw new Error("Failed pattern match at Game line 221, column 5 - line 222, column 12: " + [ v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                  };
              };
          };
  ...
  var mergeRow = function (merge) {
      return function (v) {
          var mergeCell = function (v1) {
              if (v1 instanceof Empty) {
                  return Empty.value;
              };
              if (v1 instanceof Single) {
                  return new Single(v1.value0);
              };
              if (v1 instanceof Double) {
                  return new Single(merge(v1.value0)(v1.value1));
              };
              throw new Error("Failed pattern match at Game line 333, column 5 - line 333, column 28: " + [ v1.constructor.name ]);
          };
          return Row.create(Data_Functor.map(Data_Functor.functorArray)(mergeCell)(v.value0));
      };
  };
  var mergeBoard = function (v) {
      return Board.create(Data_Functor.map(Data_Functor.functorArray)(mergeRow(Data_Function["const"]))(v.value0));
  };
  var isValidMove = function (eqVal) {
      return function (dir) {
          return function (v) {
              ...
              var v1 = mergeBoard(stackMove(eqVal)(dir)(v));
  ...
  var functorCell = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Game line 303, column 8 - line 303, column 44: " + [ m.constructor.name ]);
      };
  });
          ...
          if (v instanceof Move) {
              if (!Anim.isRunning(boardAnimable(Block.blockAnimable))(game.board) && isValidMove(eqAnimBlock)(v.value0)(game.board)) {
                  ...
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)((function () {
                      var $261 = {};
                      for (var $262 in game) {
                          if ({}.hasOwnProperty.call(game, $262)) {
                              $261[$262] = game[$262];
                          };
                      };
                      $261.board = board$prime;
                      $261.animationRunning = true;
                      $261.score = game.score + mergeScore(board$prime) | 0;
                      return $261;
                  })());
              };
              if (Data_Boolean.otherwise) {
          ...
          if (v instanceof Ticked) {
              if (Anim.isRunning(boardAnimable(Block.blockAnimable))(game.board)) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)((function () {
                      var $265 = {};
                      for (var $266 in game) {
                          if ({}.hasOwnProperty.call(game, $266)) {
                              $265[$266] = game[$266];
                          };
                      };
                      $265.board = Anim.animate(boardAnimable(Block.blockAnimable))(v.value0)(game.board);
                      return $265;
                  })());
              };
              if (game.animationRunning) {
                  return function __do() {
                      var v1 = insertRandom(game.params)(mergeBoard(game.board))();
                      if (v1 instanceof Data_Maybe.Nothing) {
                          var $270 = {};
                          for (var $271 in game) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          var $273 = {};
                          for (var $274 in game) {
                              if ({}.hasOwnProperty.call(game, $274)) {
                                  $273[$274] = game[$274];
                              };
                          };
                          $273.board = v1.value0;
                          $273.animationRunning = false;
                          $273.gameOver = !Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (mv) {
